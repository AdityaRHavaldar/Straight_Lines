...
input{
   ...
   <body style="background-color: rgba(0, 0, 0); ">
    <center> <h1 class="ani" style="text-align: center;position: relative; bottom:40px; ">distance between two  points</h1></center> 


<div class="column" style="">
  <a href="home page.html" style="margin-left: 565px;font-size: 15px;margin-top:600px;color:orange">HOME</a>
  
<div class="dss">
  <label>ENTER THE VALUE OF X1 </label>
  <input type="number" name="" id="first" maxlength="3" autofocus="on"style=" width: 75px;height: 30px;"><br><br><br>
  <label>ENTER THE VALUE OF Y1</label>
  <input type="number" name="" id="second" maxlength="3" style=" width: 75px;height: 30px;"><br><br><br>
  <label>ENTER THE VALUE OF X2 </label>
  <input type="number" name="" id="third" maxlength="3"style=" width: 75px;height: 30px;"><br><br><br>
  <label>ENTER THE VALUE OF Y2 </label>
  <input type="number" name="" id="fourth" maxlength="3" style=" width: 75px;height: 30px;"><br><br><br>
  
  <div class="nikil">
  <button class="glow-on-hover" type="button" id="dist" onclick="distance();draw();" style="color: white">CALCULATE</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  <a href="distancebtw.html"><button  class="glow-on-hover"  type="reset" id="dist" onclick="reset">RESET</button></a>
  </div>

</div>
  <label style="font-size: 20px;color: orange;"><b>DISTANCE BETWEEN TWO POINTS</b></label>
  <input type="text" name=""   id="dis" style=" width: 200px;height: 30px ;margin-bottom: 30px;"><br>
...
y = y2-y1;
  ...
  document.getElementById("dis").value= parseInt(distance);
}
</script>
<script>
